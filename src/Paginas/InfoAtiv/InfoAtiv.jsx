...
import { FaListAlt, FaPlus, FaSearch, FaTrash, FaEdit, FaBackspace, FaExclamationCircle, FaSave, FaTimes } from 'react-icons/fa';
            ...
            <div className="bg-white p-0 rounded shadow w-100" style={{ minHeight: '90vh' }}>
                ...
                <Container className='mt-2'>
                    <Card>
                        <Card.Header as="h4">
                            <Row>
                                <Col lg='2'>Atividade:</Col>
                                <Col lg='10'>
                                    <Row className="justify-content-end">
                                        <Col lg='12'>
                                            <Form.Group className='mb-3 d-flex'>
                                                <Form.Control className="border-secondary me-2" type="text"
                                                    placeholder="Pesquise o Nome da Atividade Sustentável"
                                                    value={pesquisa} onChange={(e) => setPesquisa(e.target.value)}
                                                    style={{ flexGrow: 1 }} />
                                                <Button variant="secondary" className="me-2"
                                                    onClick={() => { handlePesquisa(); alternarVisibilidade(); }}
                                                    style={{ whiteSpace: 'nowrap' }}>
                                                    <FaSearch /> Pesquisar
                                                </Button>
                                                <Button variant="secondary" onClick={limparAtividades} style={{ whiteSpace: 'nowrap' }}>
                                                    <FaBackspace /> Limpar
                                                </Button>
                                            </Form.Group>
                                        </Col>
                            ...
                            <Row>
                                <Col lg='8'>
                                    <Form.Group className='mb-3'>
                                        ...
                                        {erro && novaAtividade.trim().length < 20 && <div className="text-danger mt-1">{erro}</div>}
                                    </Form.Group>
                                </Col>
                                <Col lg='2'>
